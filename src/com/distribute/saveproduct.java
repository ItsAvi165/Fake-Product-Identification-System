...
public class saveproduct extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String datainfo=productName+ companyname+Descriptionname+mfgdate+price+Expirydate+qty+product_No+totalprice+emailid+Distribute_Mobile_No;
			//
			
			
			ptop.ptopverify(4,datainfo);
		} catch (Exception e) {
