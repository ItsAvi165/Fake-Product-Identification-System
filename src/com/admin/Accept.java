...
//					datainfo=datainfo + ExpiryDate+"@0@";
//				}
...
//				pw.println("heloooowewdwcc");
//				System.out.println("heowoenonosan");
				...
				pw.println("<html><script>alert('Required Quantity not available');</script><body>");
				pw.println("");
				pw.println("</body></html>");
