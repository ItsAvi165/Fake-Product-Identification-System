...
<body>
	...
	{
	out.println("<script>alert('Unable to scan the product...!')</script>");	
	}
	if(request.getParameter("Fake")!=null)
	{
	out.println("<script>alert('Counterfeit Product Detected...!')</script>");	
	}
   %>
	<header>		
		<div class="container">
		  ...
		  <div class="col-sm-12 col-md-8">
			<div class="row">
				<table align="center">
					...
					<tr>
						<td colspan="2"><b>User - Upload QR Code</b></td>
					</tr>
            	</table>	
            		<%
