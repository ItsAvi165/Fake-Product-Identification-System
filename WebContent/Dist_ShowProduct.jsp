	...
	<header>		
		<div class="container">
			...
			<ul class="main-menu" id="main-menu">
				...
				<li><a href="U_DistributeDataShow.jsp" class="current-demo">User Data</a></li>
				<li><a href="Distribute_UserPayBillDataShow.jsp" class="current-demo">Payment Data</a></li>
		 ...
		 <div class="row">
		  <div class="col-sm-12 col-md-8">
			...
			<form action="saveproduct" method="post" class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey pr-50 pr-sm-0">
					...
					<tr>
						<td><b>Quantity</b></td>
						<td><input type="text" name="qty"  value="<%=oldqty %>" readonly="readonly" placeholder="Enter Qty" required="required" pattern="^[1-9]\d*(\.\d+)?$" /></td>
						
						<td><b>Total Price</b></td>
						<td><input type="text" name="totalprice" readonly="readonly"  value="<%=totalprice %>" placeholder="Enter Qty" required="required" pattern="^[1-9]\d*(\.\d+)?$" /></td>
