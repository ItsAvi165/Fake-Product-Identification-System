...
<body>
	...
	else if(request.getParameter("ExpiryInvalid")!=null)
	{
	out.println("<script>alert('Expiry Date Invalid')</script>");	
	}
	else if(request.getParameter("MFGInvalid")!=null)
	{
	out.println("<script>alert('MFG Date Invalid')</script>");	
	}
   %>
	<header>		
		<div class="container">
		  ...
		  <div class="col-sm-12 col-md-8">
			...
			<form action="Addproduct" method="post" class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey pr-50 pr-sm-0">
					...
					<tr>
						...
						<td><b>MFG. Date</b></td>
						<td><input type="date" name="mfgdate" required max="2023-05-17" /></td>
						</tr>
					<tr>
						<td><b>Price</b></td>
						<td><input type="text" name="price" placeholder="Enter Price" required="required" pattern="^[1-9]\d*(\.\d+)?$" /></td>
						<td><b>Expiry Date</b></td>
						<td><input type="date" name="Expirydate" min="2023-05-17"  /></td>
					</tr>
					<tr>
						<td><b>Quantity</b></td>
