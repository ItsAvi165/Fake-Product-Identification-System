...
<body>
	...
	{
	out.println("<script>alert('Fake Product Detected...!')</script>");	
	}
		  ...
		  <div class="col-sm-12 col-md-8">
			<div class="row">
				<table align="center">
					...
					<tr>
						<td colspan="2"><b>Distributor - Upload QR Code</b></td>
					</tr>
            	</table>	
            		<%
						...
						<form class="post_section" action="QRCodeupload" method="post" enctype="multipart/form-data">
							<table align="center" border="0"  cellpadding="5" cellspacing="5">
								...
								<tr>
							        ...
							        <!--<td><input type="file" name="qrcodefile" value="QR" accept="image/*; capture=camera" /></td> -->
							        <!-- <input type="file" name="qrcodefile" placeholder="Select Document" accept="image/*" capture> -->
