		  ...
		  <div class="col-sm-12 col-md-8">
			...
			<form action="distupdateproduct" method="post" class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey pr-50 pr-sm-0">
					 ...
					 <tr>
						...
						<td><input type="text" name="productName" readonly="readonly" required="required" value="<%=productName %>" placeholder="product Name"/></td>
						<td><b>Company Name</b></td>
						<td><input type="text" name="companyname" readonly="readonly" pattern="[A-Za-z].{1,}" value="<%=CompanyName %>" placeholder="Company Name" title="Minimum Two  Characters  are Required For Company Name" required /></td>
					</tr>
					<tr>
						<td><b>Description</b></td>
						<td><input type="text" name="Descriptionname" readonly="readonly"  value="<%=DescriptionName %>" pattern="[A-Za-z].{1,}" title="Minimum Two  Characters  are Required For First Name"  placeholder="eg. Description" required /></td>
						<td><b>MFG. Date</b></td>
						<td><input type="text" name="mfgdate" required value="<%=MFGDate %>"  readonly="readonly" /></td>
						</tr>
					<tr>
						<td><b>Price</b></td>
						<td><input type="text" name="price" value="<%=Price %>" placeholder="Enter Price" required="required" pattern="^[1-9]\d*(\.\d+)?$" /></td>
						<td><b>Expiry Date</b></td>
						<td><input type="text" name="Expirydate" required value="<%=ExpiryDate %>" readonly="readonly"/></td>
					</tr>
					<tr>
						<td><b>Quantity</b></td>
